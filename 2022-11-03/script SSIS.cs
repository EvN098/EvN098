...
namespace ST_309d692e5cc34d37880e6c197fb6f511
{
    /// <summary>
	...
	public partial class ScriptMain : Microsoft.SqlServer.Dts.Tasks.ScriptTask.VSTARTScriptObjectModelBase
	{
		...
		public void Main()
		{
            ...
            try
            {
                ...
                /*** Crear coleccion de Hojas de excel ***/

                string[] SheetsArray = { Dts.Variables["User::SheetName"].Value.ToString() 
                                         //,Dts.Variables["User::SheetName2"].Value.ToString() 
                                         //,Dts.Variables["User::SheetName3"].Value.ToString()
                                         //,Dts.Variables["User::SheetName4"].Value.ToString()
                                         //,Dts.Variables["User::SheetName5"].Value.ToString()
                                        };              
                ...
                //descomentar: Excel_OLE_Cmd.CommandText = "Create table " + SheetName + " (" + TableColumns + ")";

                /**Crear coleccion de hojas de excel ***/
                //Iterar en la coleccion el command y ejectuar 
                foreach (string a in SheetsArray)
                {

                    Excel_OLE_Cmd.CommandText = "Create table " + a + " (" + TableColumns + ")";
                }
                /***************************************/
